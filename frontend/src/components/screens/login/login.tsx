...
{errorText &&
    ...
    <div className="bg-[#363740] flex flex-row justify-center w-full h-full min-h-screen">
      <div className="bg-sidebar-bg w-[1512px]">
        <div className="relative w-[452px] h-[643px] top-[139px] left-[530px] bg-grayscale-white rounded-[8px] overflow-hidden border border-solid border-grayscale-divider">
          <div className="absolute w-[216px] h-[20px] top-[543px] left-[118px]">
